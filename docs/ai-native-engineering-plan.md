...
17-section lesson format. This doc holds status, sequencing, running examples and lessons learned.
...
- [ ] **1.1.1 How software gets built, and where the time goes** ← next
...
2. For each lesson:
   - Read its `course.yaml` entry and the module notes below. Skim the previous lesson's sections 15–16.
